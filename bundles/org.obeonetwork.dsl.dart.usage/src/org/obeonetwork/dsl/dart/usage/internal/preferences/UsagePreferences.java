...
public class UsagePreferences {
	 ...
	 */
	public static final String USAGE_USER_ANSWER_ID = "usage_user_answer_preference"; //$NON-NLS-1$

	/**
	 * Key for usage report enabled preference in preference store.
	 */
	public static final String USAGE_ENABLED_ID = "usage_enabled_preference"; //$NON-NLS-1$

	/**
	 * Key for diagrams usage preference in preference store.
	 */
	public static final String USAGE_DIAGRAMS_ID = "usage_diagrams_preference"; //$NON-NLS-1$

	/**
	 * The preference store.
	 */
	private IPreferenceStore preferenceStore = DartDesignerPlugin.getDefault().getPreferenceStore();
