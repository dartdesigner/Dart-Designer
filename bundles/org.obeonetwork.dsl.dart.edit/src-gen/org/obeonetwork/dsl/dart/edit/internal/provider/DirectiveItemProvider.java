...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.dart.Directive} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DirectiveItemProvider extends AngularTypeItemProvider {
	/**
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	...
	protected void addSelectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
				.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Directive_selector_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Directive_selector_feature",
						"_UI_Directive_type"), DartPackage.Literals.DIRECTIVE__SELECTOR, true, false, false,
	...
	public String getText(Object object) {
		String label = ((Directive)object).getSelector();
		return label == null || label.length() == 0 ? getString("_UI_Directive_type")
