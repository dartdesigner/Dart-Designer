...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.dart.Decorator} object. <!--
...
public class DecoratorItemProvider extends ClassItemProvider {
	...
	protected void addSelectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
				.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Decorator_selector_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Decorator_selector_feature",
						"_UI_Decorator_type"), DartPackage.Literals.DECORATOR__SELECTOR, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns Decorator.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
