...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.dart.Library} object. <!--
...
public class LibraryItemProvider extends DartResourceItemProvider {
	...
	/**
	 * This adds a property descriptor for the Parts feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addPartsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
				.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Library_parts_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Library_parts_feature",
						"_UI_Library_type"), DartPackage.Literals.LIBRARY__PARTS, true, false, true, null,
				null, null));
	}
	...
	protected void addMetadataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
				.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Library_metadata_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Library_metadata_feature",
						"_UI_Library_type"), DartPackage.Literals.LIBRARY__METADATA, true, false, true, null,
				null, null));
	}
